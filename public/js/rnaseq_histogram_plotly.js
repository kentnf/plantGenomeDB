 ...
 */
 /*
function rnaseq_histogram(rnaseq_exps) {
	...
	for (var n in rnaseq_exps ) {

		var project = rnaseq_exps[n];
		console.log(project);
		console.log("xXXXX");
	...
	jQuery('#rnaseq-form-select').html(bioproject_opts);
